...
@section('pageTitle', isset($pageTitle) ? $pageTitle : "Page 15")
@section('content')
...
<div class="px-4" style="margin-left: 200px; margin-right: 200px;">
  <div class="text-center mb-5 mt-5">
    ...
    <div class="btn-group" role="group" aria-label="Basic example">
      <button type="button" class="btn btn-#D3D0FF px-5" style="color:#626262;">Monthly</button>
      <button type="button" class="btn btn-white  btn-outline-primary px-5" style="background: #D3D0FF; color:#626262;">Yearly</button>
    </div>
  </div>
  <div class="row">
      ...
      <div class="card">
        <div class="card-body">
          <div class="text-center">
            ...
            <h5 class="mb-4">N5,000 <span>/m</span></h5>
      ...
      <div class="card">
        <div class="card-body">
          <div class="text-center">
            ...
            <p class="card-text">Designed for DIY landlords and small portfolios.</p>
            <h5 class="mb-4">N15,000 <span>/m</span></h5>
            <a href="#" class="btn btn-white  btn-outline-primary mt-4" style="color: #524CBF; border: 1px solid #524CBF"><h6 class="my-auto">Get Started</h6></a>
          </div>
      ...
      <div class="card">
        <div class="card-body">
          <div class="text-center">
            ...
            <p class="card-text">Designed for DIY landlords and small portfolios.</p>
            <h5 class="mb-4">N35,000 <span>/m</span></h5>
