...
<div style="margin-left: 20px; margin-right: 40px;">
  <div class="d-flex justify-content-between align-items-center p-2">
      ...
      <div class="">
          <p class="px-auto p-2 bcp" style="color: white;">Need Help with Movers</p>
      </div>
  </div>        
          ...
          <div class="col">
            <div class="card mp">
              <div class="card-body d-flex py-1" style="">
                ...
                <a href=""><h5 class="btn p-3 my-auto" style="background: ">Wallet Balance</h5></a>
              </div>
            ...
            <div class="card" style="background: #D3D0FF;">
              ...
              <div class="card-body" style="mt-0 pt-0">
                  <div class="text-center mx-auto mt-0" style="border-radius: 50%; width:100px; height:100px; border:1px solid black;">
                      <div class="card-title bcp mx-auto text-center" style="border-radius: 50%; width:80px; height:80px; margin-top:10px;">
          ...
          <div class="col">
            <div class="card">
              <div class="card-body text-center my-3" style="">
                <div class="bcp mx-auto my-auto rounded-circle d-flex align-items-center shadow" style="width:150px; height:150px; margin-top:10px; background:rgb(82, 76, 191, 0.29)">
